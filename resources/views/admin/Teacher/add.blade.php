...
@section('content')
	...
	<div class="result_wrap">
        <div class="result_title">
            <h3><i class="fa fa-plus"></i>添加信息<br></h3>
            @if($errors!=null)
                <div class="mark">
                    @if(is_object($errors))
    ...
    <div class="result_wrap">
        <form action="{{url('admin/teacherinfo')}}" method="post">
            {{csrf_field()}}
            <table class="add_tab">
                <tbody>
                    <tr>
                        <th>信息名称：</th>
                        <td>
                            <input type="text" class="sm" name="information_name">
                        </td>
                    </tr>
                    <tr>
                        <th>内容：</th>
                        <td>
                            <input type="text" class="lg" name="information_value">
                        </td>
                    </tr>
                    <tr>
                        <th></th>
