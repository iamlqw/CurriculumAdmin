...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/teacherinfo')}}">首页</a> &raquo; <a href="{{url('admin/experiment')}}">课程作业/实验</a> &raquo; <a href="{{url('admin/experiment/content/'.$document->experiment_id)}}">详情</a> &raquo; 批改
    </div>
    <!--面包屑导航 结束-->
