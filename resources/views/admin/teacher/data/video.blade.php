...
@section('content')
	<link href="{{asset('resources/org/vide7.4.1/css/video-js.min.css')}}" rel="stylesheet">
	<!--面包屑导航 开始-->
    ...
    <div class="m">
      <video id="my-video" class="video-js" controls preload="auto" width="960" height="400"
        ...
        <source src="/storage/app/public/uploads/{{$field->data_videopath}}" type="video/mp4">
